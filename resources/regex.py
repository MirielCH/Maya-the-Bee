...
COMMAND_CALENDAR = re.compile(r"\bcalendar\b")
...
COMMAND_EASTER_CALENDAR = re.compile(r"\beaster\b\s+\bcalendar\b")
COMMAND_EASTER_HUTCH = re.compile(r"\beaster\b\s+\bh(?:utch)?\b")
COMMAND_FUSION = re.compile(r"\bfusion\b")
COMMAND_HIVE = re.compile(r"\bhive\b")
COMMAND_INCUBATOR = re.compile(r"(?:\bincubator\b|\binc\b)")
...
COMMAND_USE_CANDY = re.compile(r"\buse\b\s+\bcandy\b")
COMMAND_USE_EASTER_EGG = re.compile(r"\buse\b\s+(?:\beaster\b\s+)?\begg\b")
